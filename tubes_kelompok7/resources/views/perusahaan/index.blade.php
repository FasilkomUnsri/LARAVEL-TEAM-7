...
<html lang="en" class="h-100">
  ...
  <body class="d-flex flex-column h-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark shadow" style="background-color:#313031";>
      <div class="container">
        <a class="navbar-brand">KELOMPOK 7 | MENAMBAH DATA PEGAWAI
        </a>
    ...
    <section id="section_perusahaan">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <a href="{{ route('perusahaan.create') }}" class="btn btn-md btn-success mb-3">TAMBAH DATA PEGAWAI
              </a>
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $perusahaan->jenis_kelamin }}
                    </td>
                    <td>{{ $perusahaan->tempat_kelahiran }}
                    </td>
                    <td>{{ $perusahaan->tanggal_lahir }}
                    </td>
                    ...
                    <td class="text-center">
                      <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('perusahaan.destroy', $perusahaan->id) }}" method="POST">
                        <a href="{{ route('perusahaan.edit', $perusahaan->id) }}" class="btn btn-sm btn-primary">EDIT
                        </a>
                        @csrf
                        @method('DELETE')
