              ...
              <div class="card border-0 shadow rounded">
                <div class="card-body">
                  <form action="{{ route('perusahaan.update', $perusahaan->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label class="font-weight-bold">TEMPAT KELAHIRAN
                      </label>
                    ...
                    <div class="form-group mb-5">
                      ...
                      <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="5" placeholder="Masukkan Data">{{ old('alamat', $perusahaan->alamat) }}
                      </textarea>
                      @error('alamat')
                      <div class="alert alert-danger mt-2">
                        {{ $message }}
